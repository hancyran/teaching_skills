...
insert into order_info values(1, 100, '数据库原理与实践','数据库的基本常识和应用', 1000,  1,1, 1, '2', 100, null, null, null);
insert into order_info values(2, 100, '数据库设计', '数据库的基本常识和应用',1000,  1,1, null, '0', 200, null, null, null);
insert into order_info values(3, 100, '数据库高级编程', '数据库的基本常识和应用',1000,0, 1, null, '0', 100, null, null, null);
insert into order_info values(4, 101, '数据结构', 'c++应用数据结构',1000,  1,1, 1, '2', 100, null, null, null);
insert into order_info values(5, 100, '高级数据库设计', '数据库的基本常识和应用', 1000, 1,1, null, '0', 200, null, null, null);
insert into order_info values(6, 100, 'MYSQL的数据库应用','数据库的基本常识和应用',1000, 0, 1, null, '0', 100, null, null, null);
insert into order_info values(7, 100, '数据库实战', '数据库的基本常识和应用',1000,  1,1, 1, '2', 100, null, null, null);
insert into order_info values(8, 100, '大数据应用', '数据库的基本常识和应用',1000,  1,1, null, '0', 200, null, null, null);
insert into order_info values(9, 100, 'python数据分析','数据库的基本常识和应用',1000,  0, 1, null, '0', 100, null, null, null);
insert into order_info values(10, 100, 'python数据分析','数据库的基本常识和应用',1000,  0, 1, null, '0', 100, null, null, null);
insert into order_info values(11, 100, '数据科学入门','数据库的基本常识和应用',1000,  0, 1, null, '0', 100, null, null, null);
